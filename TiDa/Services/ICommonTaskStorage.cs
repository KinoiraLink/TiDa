...
namespace TiDa.Services
{
    ...
    public static class WeekTaskStorageConstants
    {
        /// <summary>
        /// 收藏数据库版本号
        /// </summary>
    ...
    public static class TomatoTaskStorageConstants
    {
        /// <summary>
        /// 收藏数据库版本号
        /// </summary>
        ...
        /// 收藏数据库版本号的键。
        /// </summary>
        public const string VersionKey = nameof(TomatoTaskStorageConstants) + "." + nameof(Version);
    }
